...
void ll_flt::resetpt(void **pt) { *pt = Topleft; }
...
float ll_flt::llpt(void *pt) { return (((node *)pt)->info); }

void ll_flt::advpt(void **pt) { *pt = ((node *)*pt)->seg; }

void ll_flt::modpt(void *pt, float info) { ((node *)pt)->info = info; }
